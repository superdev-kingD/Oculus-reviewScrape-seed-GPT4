...
class LightSportReviewScraper:
    ...
    def collect_reviews(self):
        self.run_browser('https://www.oculus.com/experiences/quest/4175028349266073/')
        time.sleep(1)
        ...
        df.to_csv('LightSport_Reviews.csv')

if __name__ == "__main__":
    LightSportReviewScraper = LightSportReviewScraper()
    LightSportReviewScraper.collect_reviews()