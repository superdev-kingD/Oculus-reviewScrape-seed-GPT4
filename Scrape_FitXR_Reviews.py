...
class FitXRScraper:
    ...
    def collect_reviews(self):
        self.run_browser('https://www.oculus.com/experiences/quest/2327205800645550/')
        time.sleep(1)
        ...
        df.to_csv('FitXR_Reviews.csv')

if __name__ == "__main__":
    FitXRScraper = FitXRScraper()
    FitXRScraper.collect_reviews()