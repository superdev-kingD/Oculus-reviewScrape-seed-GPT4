...
class SupernaturalScraper:
    ...
    def collect_reviews(self):
        self.run_browser('https://www.oculus.com/experiences/quest/1830168170427369/')
        time.sleep(1)
        ...
        df.to_csv('Supernatural_Reviews.csv')

if __name__ == "__main__":
    Supernatural = SupernaturalScraper()
    Supernatural.collect_reviews()